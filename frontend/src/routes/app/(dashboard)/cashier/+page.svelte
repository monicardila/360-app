...
<section>
	<div class="hidden md:block text-sm text-center my-4">
		<h3>Punto de venta</h3>
	</div>

	<div
		class=" p-10 w-full mx-auto bg-white relative flex flex-wrap gap-2 text-sm"
	>
		<!-- Contenedor Izquierdo -->
		<div
			class="hidden xl:block max-w-sm bg-white p-10 flex-grow drop-shadow-2xl border border-black"
		>
		...
		<!-- Contenedor Central -->
		<div
			class="hidden md:block mx-auto xl:mx-2 min-w-[250px] max-w-4xl bg-white p-8 shadow-md flex-grow mt-0 drop-shadow-2xl border border-black"
		>
				...
				<form class="absolute right-0 bottom-14">
					<label class=" right-80 absolute">
						...
						>
							...
							<option value="opcion"> Alexandra Moreno</option>
		...
		<div class="w-full container md:hidden">
			<h3 class="text-secondary mb-10 font-bold text-[26px] font-primary">
				Escanear productos
			</h3>
			<div class="grid grid-rows-2 p-x">
				<div>
					<p class="text-lg">Conectar con el computador</p>
					<p class="text-[16px] text-gray-400">Activar bluetooth</p>
				</div>
